# Lát cắt dọc (Vertical Slice) — Lộ trình triển khai vlxd-v3

<callout icon="🪚">Tài liệu này **thay đổi cách triển khai** dự án `HomyHubs/vlxd-v3`: từ "làm xong backend rồi mới làm frontend" sang **lát cắt dọc (vertical slice)**. Mỗi 2–4 task phải cho ra **một màn hình bấm được**, dù logic bên trong còn giả lập.

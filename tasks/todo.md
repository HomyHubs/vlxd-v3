...
- [x] 3.1 — Migration `warehouses`, `stock_levels`, DB types và rollback test.
...
- [x] 3.2 — Contract/API `GET /warehouses`, `POST /warehouses` và giới hạn kho theo gói.
...
- [x] 3.3 — UI `/warehouses` và tồn kho trên `/products`.
